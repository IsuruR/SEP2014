            ...
            <fieldset >
                ...
                <asp:Panel ID="pnlError" Visible="false" runat="server">
                    <div class='alert alert-error'>
                     <strong>Error!</strong>
                        candidate didn't add successfully.
                     </div>
                </asp:Panel>
                ...
                <div class="control-group">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="drpSex" ErrorMessage="*This information is required." ForeColor="#CC0000" ValidationGroup="Emp" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </div>
                </div>
                  <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtTwitterUrl" ErrorMessage="*This information is required." ForeColor="#CC0000" ValidationGroup="Emp"></asp:RequiredFieldValidator>
                    </div>
                </div>
                    <div class="control-group">
                    <asp:Label ID="Label7" class="control-label" runat="server" Text="Facebook Page URL"></asp:Label>

                    <div class="controls">
                        <asp:TextBox ID="txtFacebookUrl" class="input-xxlarge" runat="server" ></asp:TextBox>
                    </div>
                </div>
                    <div class="control-group">
