<%@ Page Language="C#" AutoEventWireup="true" CodeFile="compareArtist.aspx.cs" Inherits="compareArtist" %>
    ...
    <script type="text/javascript">
        ...
        function drag(ev) {
            ...
            $.ajax({
                ...
                url: "compareArtist.aspx/getName",
   ...
   <div style="text-align:center">
    ...
    <script>
            ...
            var topic = d3.select("#drop").append("div").append("text")
                                ...
                                .text("Overall Popularity");//need to pass
            ...
            d3.csv("Popularity.csv", function (error, data) {
                ...
                y.domain([0, d3.max(data, function (d) { return Math.max(d.popularity); })]);//need to changes
                ...
                btnclbk = function (a) {
                    ...
                    dot = svg.selectAll("dot")
                           ...
                           .on("mouseover", function (d) {
                               ...
                               .duration(200)
                               .style("opacity", .9);
                               div.html(d.popularity + "<br/> Overall Score for "+d.artist)
                    ...
                    label = svg.append("text")
                            .attr("transform", "translate(" + x((filtered[0].date)) + "," + y(filtered[0].popularity) + ")") //check y axis
                            .attr("dy", ".35em")
