...
CREATE TABLE youtube(
	...
	likes INT,
	dislikes INT,
	commentLink VARCHAR(500),
	CONSTRAINT pk_utube PRIMARY KEY (name,videoId)
)
...
select * from youtube;
select * from knockouts;

insert into knockouts values('Leo Ihenacho');
insert into knockouts values('Jai McConnell');
insert into knockouts values('Jade Mayjean');
insert into knockouts values('Lee Glasson');
insert into knockouts values('Femi Santiago');
insert into knockouts values('Rachael O''Connor');
insert into knockouts values('Jamie Johnson');

insert into knockouts values('Celestine');
insert into knockouts values('Melissa Gill');
insert into knockouts values('Gary Poole');
insert into knockouts values('Bizzi Dixon');
insert into knockouts values('Georgia Harrup');
insert into knockouts values('Steven Alexander');
insert into knockouts values('Sally Barker');

insert into knockouts values('Jessica Steele');
insert into knockouts values('Chris Royal');
insert into knockouts values('Beth McCarthy');
insert into knockouts values('Christina Marie');
insert into knockouts values('Jazz Bates');
insert into knockouts values('Max Murphy');
insert into knockouts values('Emily Adams');

insert into knockouts values('James Byron');
insert into knockouts values('Iesher Haughton');
insert into knockouts values('Callum Crowley');
insert into knockouts values('Jermain Jackman');
insert into knockouts values('Anna McLuckie');
insert into knockouts values('Nomakhosi Nkosi');
insert into knockouts values('Sophie May');
